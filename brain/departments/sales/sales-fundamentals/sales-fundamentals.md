...
its own file (or its own set of lesson files, for modules with multiple
lessons). Real content is filled in one module at a time as it's provided.

# Sales Fundamentals

12-part sales curriculum, in order:

## 01. Sales Fundamentals — Module 0: Foundations & Control

Six lessons, real content:

- [[what-sales-actually-is]]
- [[setting-the-tone-early]]
- [[tonality-slower-calmer-more-certain]]
...
- [[diagnosis-and-problem-amplifying]]
